    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/THECIDKAGENOUSUPPORT for support")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/THECIDKAGENOUSUPPORT for support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by \nhttps://t.me/THECIDKAGENOUSUPPORT")
        self.LOGGER(__name__).info(f""" \n\n       
                                                   
                  
                                 

  _____ _  _ ___ ___ ___ ___   _   _  _ ___ __  __ ___  
 |_   _| || | __/ __|_ _|   \ /_\ | \| |_ _|  \/  | __| 
   | | | __ | _| (__ | || |) / _ \| .` || || |\/| | _|  
   |_| |_||_|___\___|___|___/_/ \_\_|\_|___|_|  |_|___| 
